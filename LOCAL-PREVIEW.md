...
This pass updates typography and insight visuals while preserving the original website copy, section order, hero CTA, plan data, and interaction hooks. Two thumbnails are HTML-rendered diagrams with matching light and dark exports, and two are generated photographs. Editable artwork and prompts are in `frontend/design`. Existing backgrounds and the Syed and Ramisa portraits are retained. Reviews scroll left continuously, loop seamlessly, and support dragging. Autoplay pauses during dragging and respects reduced-motion preferences. The partner tools strip remains manually browsable.
